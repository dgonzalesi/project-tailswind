    ...
    <section id="testimonials">
      ...
      <div className="max-w-6xl px-5 mx-auto mt-32 text-center">
        ...
        <div className="flex flex-col mt-24 md:flex-row md:space-x-8">
          ...
          {/* Testimonial 2 */}
          <div className="hidden flex flex-col items-center p-6 space-y-6 rounded-lg bg-gray-100 md:flex md:w-1/3">
            <img
              src={testimonial2}
              alt="Ali bravo avatar picture"
          ...
          <div className="hidden flex flex-col items-center p-6 space-y-6 rounded-lg bg-gray-100 md:flex md:w-1/3 hover:h-50">
            <img
              src={testimonial3}
              alt="Richard Watts profile picture"
              className="w-16 -mt-14"
            />
            <h5 className="text-lg text-center font-bold">Richard Watts</h5>
            <p className="text-sm text-sky-800">
              “Manage has supercharged our team#&39;s workflow. The ability to
              maintain visibility on larger milestones at all times keeps
              everyone motivated.”
            </p>
          </div>
        ...
        {/* Button */}
        <div className="flex justify-center md:justify-center pt-10">
          <a
            href=""
            className="md:block p-3 px-6 pt-2 text-white bg-brightRed rounded-full baseline hover:bg-rose-900">
            Get Started
          </a>
        </div>
      </div>
